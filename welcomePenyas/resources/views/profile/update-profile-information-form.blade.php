<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="description">
        {{ __('Actualiza la información de tu cuenta, cambia tu contraseña, aumenta tu seguridad o elimina tu cuenta') }}
    </x-slot>
    ...
    <x-slot name="form">
        ...
        <!-- Surame -->
        <div class="col-span-6 sm:col-span-4">
            <x-label for="surname" value="{{ __('Apelldos') }}" />
            <x-input id="surname" type="text" class="mt-1 block w-full" wire:model="state.surname" />
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <!-- If we put this online, we need to change this to spanish -->
