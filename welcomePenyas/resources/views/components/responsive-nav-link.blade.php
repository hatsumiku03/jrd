...
$classes = ($active ?? false)
            ? 'block w-full ps-3 pe-4 py-2 border-l-4 border-[#d30202] text-start text-base font-medium text-gray-200 bg-[#d30202]/40 focus:outline-none focus:text-indigo-200 focus:bg-indigo-900 focus:border-indigo-300 transition duration-150 ease-in-out'
